...
void setupRC()
{
	...
	//Ze floor:
	hFloor.setColour(0.0f, 0.0f, 1.0f, 1.0f);
...
void renderScene()
{
	...
	//Draw floor:
	shaderManager.UseStockShader(GLT_SHADER_POINT_LIGHT_DIFF, tPipeline.GetModelViewMatrix(), tPipeline.GetProjectionMatrix(), vLightEyePos, hFloor.vFloorColour);
